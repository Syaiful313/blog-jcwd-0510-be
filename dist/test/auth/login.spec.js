...
describe("POST /auth/login", () => {
    it("should login successfully", () => __awaiter(void 0, void 0, void 0, function* () {
        prisma_1.prismaMock.user.findFirst.mockResolvedValueOnce(Object.assign(Object.assign({}, reqBody), { id: 1, name: "John Doe", createdAt: new Date(), updatedAt: new Date() }));
    ...
    it("should return error if password is incorrect", () => __awaiter(void 0, void 0, void 0, function* () {
        prisma_1.prismaMock.user.findFirst.mockResolvedValueOnce(Object.assign(Object.assign({}, reqBody), { id: 1, name: "John Doe", createdAt: new Date(), updatedAt: new Date() }));
